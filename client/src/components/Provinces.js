...
export class Provinces extends Component {
    ...
    render() {
        ...
        this.state.data.map((item) => {
            cvd.push(item.data[darr.length-1].change_vaccinations)
            cvd.push(item.data[darr.length-2].change_vaccinations)
            cvd.push(item.data[darr.length-3].change_vaccinations)
            cvd.push(item.data[darr.length-4].change_vaccinations)
            cvd.push(item.data[darr.length-5].change_vaccinations)
            cvd.push(item.data[darr.length-6].change_vaccinations)
            cvd.push(item.data[darr.length-7].change_vaccinations)
        })
        this.state.data.map((item) => {
