            ...
            <div className = "mainContainer">
                ...
                <div class = "infoContainer">
                    ...
                    <div class = "mainInfo" id = "aboutInfo">
                        ...
                        <p className = "aboutInfo">COVIDaware is an intuitive method for accessing all information regarding COVID-19, in a user-friendly format. All data on the COVIDaware website is made publicly available by the Canadian government. The objective of COVIDaware is to create an all inclusive tool to help users develop a deeper understanding of COVID-19 data.</p>
